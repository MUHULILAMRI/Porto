...
const Projects: React.FC = () => {
  ...
  const categories = ['All', 'Fullstack', 'Data Analysis'];
        ...
        <Reveal width="100%">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <p className="text-slate-400">
              A selection of projects demonstrating my capabilities in Fullstack Engineering and Data Analytics.
            </p>
          </div>
        </Reveal>
          ...
          >
            {categories.map((category) => (
              <button
                ...
                className={`px-6 py-2 rounded-full text-sm font-semibold transition-all duration-300 border backdrop-blur-sm ${
        ...
        >
          {filteredProjects.map((project) => {
            ...
            <Reveal key={project.id} width="100%">
              <div 
                role="listitem"
                className={`group relative rounded-2xl overflow-hidden glass-card transition-all duration-500 hover:-translate-y-2 flex flex-col h-full ${
              ...
              >
                ...
                >
                  ...
                  <div className="absolute top-4 right-4 z-20">
                    <span 
                      className={`px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wide transition-all duration-300 backdrop-blur-md shadow-lg ${
                        project.category === 'Data Analysis' 
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">
                    {project.techStack.map((tech, index) => (
                      <span 
                        ...
                        group-hover:scale-105 group-hover:bg-slate-700 ${
                          project.category === 'Data Analysis' 
          ...
          >
             {selectedProject.screenshots.map((shot, idx) => (
                <button
                   ...
                   className={`h-16 w-24 md:h-20 md:w-32 flex-shrink-0 rounded-lg overflow-hidden border-2 transition-all ${
