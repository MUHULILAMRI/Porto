        ...
        <div className="grid md:grid-cols-2 gap-12 mb-12">
          <div>
            ...
            <p className="text-slate-400 mb-6 max-w-md">
              Whether you need a fullstack application or deep data insights, I'm ready to help you achieve your goals.
            </p>
            <a 
          ...
          <div className="flex flex-col md:items-end justify-center">
             <div className="flex gap-4">
              ...
              <a href="#" className="w-10 h-10 rounded-full bg-slate-900 border border-slate-800 flex items-center justify-center text-slate-400 hover:text-white hover:border-cyan-500 transition-all">
                <Twitter size={20} />
              </a>
            </div>
          </div>
